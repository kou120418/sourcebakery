          ...
          <div class="row">
            <div class="col-sm-4">
              <div class="mb-1">
                <div class="form-group">
                  ...
                  <input
                    ...
                    class="form-control"
                    placeholder="請輸入圖片連結"
                    v-model.trim="editProduct.imageUrl"
                  />
                  <img
              ...
              <div v-if="Array.isArray(editProduct.imagesUrl)">
                <div
                  class="mb-4"
                  v-for="(item, index) in editProduct.imagesUrl"
                  :key="'addImage' + index"
                >
                  <hr />
                  <div class="form-group">
                    ...
                    <div class="mb2">
                      <button
                        ...
                        @click="editProduct.imagesUrl.splice(index, 1)"
                      >
                        刪除圖片
                      </button>
                    </div>
            ...
            <div class="col-sm-8">
              <div class="form-group">
                ...
                <input
                  ...
                  placeholder="請輸入標題"
                  v-model.trim="editProduct.title"
                />
              </div>
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  placeholder="請輸入商品描述"
                  rows="6"
                  v-model.trim="editProduct.description"
                >
                </textarea>
              </div>
              <div class="form-group mt-3">
                ...
                <textarea
                  ...
                  placeholder="請輸入商品規格"
                  rows="4"
                  v-model.trim="editProduct.content"
                >
                </textarea>
              </div>
              <hr />
              <div class="form-group">
                ...
                <input
                  ...
                  class="form-control mt-1"
                  placeholder="請輸入庫存量"
                  v-model.number="editProduct.stuck"
                />
              </div>
              <div class="form-group mt-3">
...
export default {
  ...
  watch: {
    propsProduct() {
      this.editProduct = this.propsProduct;
    },
  },
  mixins: [modalMixin],
};
